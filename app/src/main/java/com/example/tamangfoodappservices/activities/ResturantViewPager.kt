...
class ResturantViewPager : AppCompatActivity() {

    private var mSectionsPagerAdapter: SectionsPagerAdapter? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_resturant_view_pager)

        var viewPager1 = findViewById<ViewPager>(R.id.viewPagerResturant)
...
//    }
    ...
    inner class SectionsPagerAdapter(fm: FragmentManager) : FragmentPagerAdapter(fm) {
        ...
        override fun getItem(position: Int): Fragment {
            ...
            return RestaurantPlaceHolder.newInstance(position + 1)
        }
